...
// défis en cours
let defis = {}; // { id -> { adversaire1 => choix1, adversaire2 => choix2 }, ... }
...
function defier(joueur1, joueur2, choixJ1) {
  ...
  if (!beats[choixJ1]) {
    return {
      status: -1,
      message: `Le choix du joueur (${choixJ1}) est incorrect.`,
    };
  }
  ...
  if (defis[joueur2][joueur1]) {
    return {
      status: 0,
      resultat: bataille(joueur2, defis[joueur2][joueur1], joueur1, choixJ1),
    };
  }
